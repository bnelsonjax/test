...
<!-- JQuery -->
	...
	<script src="http://<?php  echo $_SERVER['HTTP_HOST']; ?>/common/theme/scripts/plugins/other/google-code-prettify/prettify.js"></script>
	...
	<!-- MiniColors Plugin -->
	<script src="http://<?php  echo $_SERVER['HTTP_HOST']; ?>/common/theme/scripts/plugins/color/jquery-miniColors/jquery.miniColors.js"></script>
	...
	<script src="http://<?php  echo $_SERVER['HTTP_HOST']; ?>/common/theme/scripts/demo/themer.js"></script>

	<!-- Twitter Feed -->
	<script src="http://<?php  echo $_SERVER['HTTP_HOST']; ?>/common/theme/scripts/demo/twitter.js"></script>

	<!-- Easy-pie Plugin -->
	<script src="http://<?php  echo $_SERVER['HTTP_HOST']; ?>/common/theme/scripts/plugins/charts/easy-pie/jquery.easy-pie-chart.js"></script>
